...
class Pype {
    ...
    public static function powered($image = true, $color = 'black', $small = false)
    {
        ...
        {
            if($small) {
                return '<a href="https://pype.jacmoe.dk/" target="_blank" rel="external noopener noreferrer"><img width="36" height="16" title="Powered by Pype" alt="Powered by Pype" src="' . Pype::logo($color, $small) . '"></a>';
            } else {
                return '<a href="https://pype.jacmoe.dk/" target="_blank" rel="external noopener noreferrer"><img width="54" height="24" title="Powered by Pype" alt="Powered by Pype" src="' . Pype::logo($color) . '"></a>';
            }
        }
