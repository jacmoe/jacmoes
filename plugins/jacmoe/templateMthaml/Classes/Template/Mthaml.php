 ...
 */
namespace Phile\Plugin\Jacmoe\TemplateMthaml\Template;
 ...
 * @package Phile\Plugin\Jacmoe\TemplateMthaml\Template
 */
class Mthaml implements TemplateInterface {
	/**
	...
	protected function getEngine() {
		$fs = new \Twig_Loader_Filesystem($this->getTemplatePath());
		$mthaml = new \MtHaml\Environment('twig', array('enable_escaper' => false));
		$loader = new \MtHaml\Support\Twig\Loader($mthaml, $fs);
